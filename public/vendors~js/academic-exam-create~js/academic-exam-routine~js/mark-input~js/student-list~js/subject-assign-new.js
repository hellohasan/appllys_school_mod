(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~js/academic-exam-create~js/academic-exam-routine~js/mark-input~js/student-list~js/subject-assign-new"],{
