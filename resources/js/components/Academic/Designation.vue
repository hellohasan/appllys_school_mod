        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold">{{ $t('Designation') }}</h3>
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr v-for="(list, index ) in lists" :key="list.id">
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm" @click="editDesignation(list)"><i class="far fa-edit"></i> {{$t('Edit')}}</button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="editMode ? updateDesignation() : createDesignation()" @keydown="form.onKeydown($event)">
...
export default {
    ...
    methods:{
        ...
        createDesignation() {
            this.form.post('/api/designations')
                .then(() => {
        ...
        updateDesignation() {
            this.form.put('/api/designations/' + this.editId)
                .then(() => {
                    this.loadDesignations();
                    $('#myModal').modal('hide');
                    Toast.fire({
        ...
        loadDesignations(){
            axios.get('/api/designations').then(({data}) => this.lists = data)
        }
    },
    created(){
        this.loadDesignations();
