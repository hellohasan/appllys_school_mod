<template>
    <form @submit.prevent="addAcademicGrade" class="p-3">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row group-markup mt-2" v-for="(grade,i) in form.grades" :key="i">
                    <div class="col-md-4">
                        <div class="form-group">
        ...
        <v-button class="mt-2" :loading="form.busy">{{ $t('Add New') }}</v-button>
    </form>
</template>
...
export default {
    ...
    methods:{
        ...
        addAcademicGrade(){
            this.form.post('/api/sore-academic-grade').then((response) => {
                Toast.fire({
                    icon: 'success',
