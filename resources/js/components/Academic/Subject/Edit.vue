						...
						<template v-if="this.form.academic_class_type == '2'">
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									...
									<custom-select :options="years" v-model="form.academic_year_id" placeholder="Select One"></custom-select>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<Select2 :options="subject_types" v-model="form.subject_type" :placeholder="$t('SubjectType')"></Select2>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<Select2 :options="religion_types" v-model="form.religion_type" :placeholder="$t('Select_One')"></Select2>
...
<script>
	...
	export default {
		...
		methods: {
			...
			loadSubjectEdit() {
				axios.get('/api/edit-academic-subject/' + this.$route.params.id).then(({ data }) => {
					this.form.fill(data.subject);
					this.form.academic_class_id = data.academic_class_id
					setTimeout(() => {
						this.form.academic_group_id = data.academic_group_id
						this.form.academic_department_id = data.academic_department_id
						setTimeout(() => {
