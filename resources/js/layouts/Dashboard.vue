<template>
	<div>
					...
					<ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
						...
						<li class="user-header bg-primary">
							...
							<p>{{ authUser.name }} - {{ authUser.roles[0] }}
								<small>{{ $t('MemberSince') }}: {{ authUser.created_at | date }}</small>
							</p>
						</li>
						<!-- Menu Footer-->
		...
		<footer class="main-footer">
			...
			<!-- Default to the left -->
			<strong>Copyright &copy; 2021-2022 <a href="https://appllys.com" target="_blank">Appllys</a>. Develop by <a href="https://softwarezon.com" target="_blank">Hasan Rahman</a></strong> All rights reserved.
		</footer>
	</div>
</template>
...
<script>
	...
	import Teacher from "./Menu/Teacher";
